...
const FlipDown = function () {
  ...
  _createClass(FlipDown, [{
    ...
    value: function start() {
      ...
      this.countdown = setInterval(this._tickOhClock.bind(this), 1000);
      return this;
    }
  }, {
    key: "ifEnded",
    ...
    value: function _tickOhClock() {
      ...
      this.clockValues.h = hours;
      this.clockValues.m = minutes;
      this.clockValues.s = seconds;
